...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self._dpdStato = ft.Dropdown(label="Stato", disabled=True)
        self._btnRaggiungibili = ft.ElevatedButton(text="Stati Raggiungibli", on_click=self._controller.handleRaggiungibili, disabled=True)



        row1 = ft.Row([self._txtAnno, self._btnCalcola], alignment=ft.MainAxisAlignment.CENTER)
        row2 = ft.Row([self._dpdStato, self._btnRaggiungibili], alignment=ft.MainAxisAlignment.CENTER)
